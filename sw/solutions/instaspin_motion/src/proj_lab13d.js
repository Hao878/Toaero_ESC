...
expAdd ("gMotorVars.SpinTAC.PosPlanRun");
expAdd ("gMotorVars.SpinTAC.PosPlanStatus");
expAdd ("gMotorVars.SpinTAC.PosPlanErrorID");
expAdd ("gMotorVars.SpinTAC.PosPlanCfgErrorIdx");
expAdd ("gMotorVars.SpinTAC.PosPlanCfgErrorCode");
expAdd ("gVendFwdButton");
expAdd ("gVendSelectButton");
expAdd ("gVendAvailableItem");
expAdd ("gVendInventory");
